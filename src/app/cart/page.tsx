...
export default function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="container py-8 sm:py-16 px-4 max-w-7xl mx-auto">
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-8">
      ...
      <div className="bg-white border-b shadow-sm sticky top-0 z-10">
        <div className="container px-4 py-3 sm:py-4 flex items-center gap-3 sm:gap-4 max-w-7xl mx-auto">
          <Link href="/menu">
            <Button
              variant="ghost"
              size="icon"
          ...
          {orderType === "dine-in" && tableNumber && (
            <Badge
              variant="secondary"
              className="text-xs sm:text-sm lg:text-base px-2 sm:px-3 py-1"
            >
              🪑 Table {tableNumber}
            </Badge>
          )}
      ...
      <div className="container px-4 py-4 sm:py-6 max-w-4xl mx-auto">
        {/* Cart Items - Improved responsive */}
        <Card className="mb-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start mb-2 gap-2">
                        ...
                        <Button
                          ...
                          className="text-red-600 hover:text-red-700 hover:bg-red-50 flex-shrink-0 h-8 w-8 sm:h-9 sm:w-9"
                        >
        ...
        {/* Order Summary - Improved responsive */}
        <Card className="mb-6">
          <CardContent className="p-4 sm:p-6">
        ...
        {/* Confirm Button - Improved responsive */}
        <Button
          onClick={handleConfirmOrder}
          disabled={loading}
          className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white py-5 sm:py-6 text-base sm:text-lg font-bold"
        >
